...
public sealed class ShrineMaiden : RoleBase, ISelfVoter
{
    ...
    public void ShrineMaidenAbility(byte votedForId)
    {
        ...
        //マッドならimpにする
        if (JekyllandHyde.UsesMadmateCommonSettings(role1) && t1 == CustomRoleTypes.Madmate) t1 = madmate is CustomRoleTypes.Madmate ? CustomRoleTypes.Impostor : madmate;
        if (JekyllandHyde.UsesMadmateCommonSettings(role2) && t2 == CustomRoleTypes.Madmate) t2 = madmate is CustomRoleTypes.Madmate ? CustomRoleTypes.Impostor : madmate;
