    ...
    {
        {
            ...
            }
            {
                var news = new ModNews
                {
                    Number = 100100,
                    Title = "夏休み満喫してるかい？",
                    SubTitle = "<color=#FF9631>●TOH-Pko v5.34.19.94</color>",
                    ShortTitle = "<color=#FF9631>●TOH-Pko v5.34.19.94</color>",
                    Text = "・TOHKのアプデに対応\r\n・ナイス猫又翻訳\r\n・ジェイラー翻訳\r\n・ミニマリスト翻訳\r\n・スタンドマスターキルクのバグ修正\r\n・賢者フリーターの就職等も返り討ちにしてしまうバグを修正\r\n・賢者その他のバグ修正\r\n・フリーターの属性まで見えるバグを修正\r\n・フリーターの色が消えるバグを修正\r\n・同じ役職が重複して勝利するバグを修正(完全に治ってるかは不明)\r\n・スペランカーが梯子で転落死しないバグを修正\r\n・ムービングのボタンの画像が表示されないバグを修正\r\n・役職のボタンの画像の追加\r\n・サンタオプション追加\r\n・トイレファンオプション追加\r\n・ジャッカルドールオプション追加\r\n・陰陽師ちょっとした仕様変更\r\n・スクラッチャー/shaで一括削りできるように仕様変更\r\n・スクラッチャーオプション追加\r\n・マッチメイキング最終更新日表示するように仕様変更\r\n・シェリフ仕様変更\r\n・村長オプション追加\r\n・ダブルキラー能力使用可能回数のオプション追加\r\n・ダブルキラーその他仕様変更\r\n・/cmd h n使用してアンチチートで蹴られるバグを修正(完全に治ってるかは不明)\r\n・テレポーターペット撫ででも能力使用可能に仕様変更\r\n・イビルリンカーファントムボタンのワンクリックでもポータル設置可能に仕様変更\r\n・イビルムービングファントムボタンのワンクリックでもポータル設置可能に仕様変更\r\n・スペランカーのベントの判定をちょっと狭めた\r\n・キューピッドオプション追加\r\n"
                    ,
                    Date = "2026-8-07"
                };
                AllModNews.Add(news);
            ...
            }
            {
                var news = new ModNews
                {
                    Number = 100103,
                    Title = "㍂",
                    SubTitle = "<color=#FF9631>●TOH-Pko v5.35.22.97</color>",
                    ShortTitle = "<color=#FF9631>●TOH-Pko v5.35.22.97</color>",
                    Text = "Kのアップデート(.53)に対応\r\n\r\n ★バグ修正★\r\n・投票バグの修正\r\n・フリーターのアドオンが見えるバグの修正\r\n・スウーパーのキルクールが必ず30秒になるバグを修正\r\n・イビルスタンドマスターが壁の中に呼び出してしまうバグを修正\r\n・一部役職がサボタージュ終了時追加勝利できないバグを修正\r\n・マッドサイコのタスク数がクルーのタスク数にカウントされてしまうバグを修正・バケネコオプションが消えてたバグを修正\r\n・賢者通常キル以外も返り討ちにしてしまうバグを修正\r\n・ゾンビ通常キル以外も感染してしまうバグを修正\r\n・任命したシェリフが死んでもシェリフモードから変わらないバグを修正\r\n・イビルスタンドマスター相方召喚で壁貫通してしまうバグを修正\r\n・ラビットオプション翻訳\r\n・id重複等のログのエラーを修正\r\n・スペランカーがリフトとジップラインで死ななかったバグを修正\r\n・波動砲バグ修正\r\n・波動砲ジャッカルバグ修正\r\n\r\n★追加要素★\r\n・/news \r\n└ 現バージョンのニュースが見れます\r\n・/n r co\r\n└ コンビネーション役職が見れます。\r\n ・禁止コマンドのオプションに試合中のみ禁止のオプションを追加\r\n└ 特に言うことなし。8月も終わりますね。\r\n ・スクラッチャーのオプション追加\r\n ・スモークメーカーのオプション追加\r\n\r\n★新役職★\r\nⒾ ヘイトキラー\r\n└ 自身への票によって自身のキルクールが短縮されます。\r\nⒸ 地蔵\r\n└ ペットを撫でることで一定時間止まり、\r\nその部屋で起こった行動が会議開始時に地蔵に通知されます。\r\nⒸ 盲信者\r\n└ マッドメイトと誤認するクルーメイトです。\r\nⒸ ブーストライター\r\n└ TOR式のライターです。ペットを撫でると一定時間視野が明るくなります。\r\nⓃ ホオジロザメ\r\n└ マグロのキル可能版です。強い。\r\nⓃ マーメイド\r\n└ チャット回数によって勝利条件が変わります。\r\n\r\n★仕様変更★\r\n・ジャッジのInfoLongを変更\r\n・タイトル画面のクルーの画像をPKO画像に変更\r\n・神がゲッサーを使用できないように仕様変更\r\n・/mod・/mod deleteを/modに統一\r\n・スタンドマスターとスタンドのイントロを変更\r\n\r\n★その他★\r\n・スラッガー完全リストラ\r\n・ジャッカルシーア完全リストラ\r\n・モイラ完全リストラ\r\n・忘却者完全リストラ\r\n・さつまといも封印\r\n・ヒッチハイカー封印\r\n・ハッピジェスター一時的に封印\r\n"
                    ,
                    Date = "2026-8-28"
                };
                AllModNews.Add(news);
            }
            {
                var news = new ModNews
                {
                    Number = 100104,
                    Title = "アプデ遅すぎた()",
                    SubTitle = "<color=#FF9631>●TOH-Pko v5.36.22.98</color>",
                    ShortTitle = "<color=#FF9631>●TOH-Pko v5.36.22.98</color>",
                    Text = "★バグ修正★\n"
                    + "・ウルトラスターの速度が戻らないバグを修正\r\n"
                    + "・乗っ取り役職が一部状況で勝利できないバグを修正\r\n"
                    + "・ゲッサーの一会議に打てる上限が機能しないバグを修正\r\n\n"
                    +"★追加要素★\r\n"
                    + "・一部役職のカスタムボタンを追加\r\n"
                    + "・一部役職のカスタムボタンを変更\r\n"
                    + "・マッドサイコ・マーメイドが複数割り当て可能に\r\n"
                    + "・ヴァンパイアに噛まれた人を通知する設定を追加\r\n"
                    + "・ナイス・イビルゲッサーに自投票+コマンドで打つ設定を追加\r\n"
                    + "・自殺願望者の設定追加\r\n"
                    + "・パワフルにキルパワーを指定できる設定を追加\r\n\n"
                    + "★仕様変更★\n・秘匿チャットのオプション位置を移動\n・役職オプションの順番を整理\n・ウォーロック仕様変更\n・パペッティア仕様変更\n・クイックキラー仕様変更\n・波動砲シェリフ仕様変更\n・期間限定役職を常時表示するように変更\n\n★新役職★\nⒾ ボマー From:ExtremeRoles\n└ クルーに爆弾を設置できます。爆弾は一定時間後に爆発します。\n\nⓃ ヴァニティ From:Nebula on the Ship\n└ 自身をシェリフと思い込みます。クルーをキルするまではクルーと追加勝利できます。\n\nⒸ ハンター From:TownOfHost_Y\n└ クルーでありながら誰でもキルできます。\n\n★その他★\n・爆弾魔リストラ\n・記憶喪失者リストラ\n・イーター復活\n・波動砲シェリフ復活\n・MODブラックリスト復活\n・神の転職前暴露をキックする設定を削除"
                    ,
                    Date = "2026-9-18"
                };
                AllModNews.Add(news);
